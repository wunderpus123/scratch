...
const Card = props => (
  <div className="card">
    ...
    <div className="dropdown">
      <button className="dropbtn" className="w3-button w3-khaki w3-round">Status</button>
    ...
    {/* <button> Edit </button> */}
    <button className="w3-button w3-red w3-round" onClick={event => deleteCard(event, props)}> Delete </button>
  </div>
);
